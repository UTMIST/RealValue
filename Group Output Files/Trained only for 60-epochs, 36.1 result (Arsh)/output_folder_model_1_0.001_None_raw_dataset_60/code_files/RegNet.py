...
def RegNet(input_shape=(64,64,3)):
    layer_list=[
                layers.Conv2D(filters=8, kernel_size=(3, 3), activation='relu', use_bias=True, input_shape=input_shape, padding="same"),
                ...
                layers.Dense(units=8, activation = 'relu', use_bias = True),
                layers.BatchNormalization(axis=-1),
                layers.Dropout(0.5),
